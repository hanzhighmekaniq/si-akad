        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('mahasiswa.presensi.index') }}"
                    class="flex items-center p-3 rounded-lg group {{ request()->routeIs('mahasiswa.presensi.*') ? 'bg-blue-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="w-5 h-5 {{ request()->routeIs('mahasiswa.presensi.*') ? 'text-white' : 'text-gray-500 group-hover:text-blue-600' }}"
                        fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd"
