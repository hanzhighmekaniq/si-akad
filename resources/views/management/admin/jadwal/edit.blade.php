<x-admin-layout>
    <x-slot name="title">Edit Jadwal Akademik - SI Akademik</x-slot>
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 mb-2">
            ...
            <h2 class="text-3xl font-bold text-gray-900">Edit Jadwal Akademik</h2>
        </div>
        <p class="mt-1 text-sm text-gray-600">Update jadwal perkuliahan</p>
    </div>
                ...
                <div>
                    ...
                    <select name="id_Gol" id="id_Gol"
                        ...
                        @foreach($golongans as $gol)
                            <option value="{{ $gol->id_Gol }}" {{ old('id_Gol', $jadwal->id_Gol) == $gol->id_Gol ? 'selected' : '' }}>
                                {{ $gol->nama_Gol }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="p-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 border border-yellow-200" role="alert">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="mt-1">Perubahan jadwal dapat mempengaruhi mahasiswa yang sudah mengambil KRS untuk mata kuliah ini.</p>
                    </div>
                </div>
            </div>
