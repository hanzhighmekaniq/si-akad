<x-admin-layout>
    <x-slot name="title">Tambah Golongan - SI Akademik</x-slot>
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 mb-2">
            ...
            <h2 class="text-3xl font-bold text-gray-900">Tambah Golongan</h2>
        </div>
        <p class="mt-1 text-sm text-gray-600">Tambahkan golongan/kelas mahasiswa baru</p>
    </div>

    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('admin.golongan.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="id_Gol" id="id_Gol" value="{{ old('id_Gol') }}"
            ...
            <div>
                ...
                <input type="text" name="nama_Gol" id="nama_Gol" value="{{ old('nama_Gol') }}"
